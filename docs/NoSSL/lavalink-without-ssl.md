...
Version 4.0.3 \ Plugins LavaSrc,LavaSearch etc   ![Uptime](https://status.alfari.id/api/badge/7/uptime)
```bash
...
Version 3.7.9 \ Plugins LavaSrc   ![Uptime](https://status.alfari.id/api/badge/6/uptime)
```bash
