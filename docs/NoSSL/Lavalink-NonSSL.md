...
Version 4.0.8 | Plugins: jiosaavn-plugin:1.0.3, skybot-lavalink-plugin:1.7.0, lavasearch-plugin:1.0.0, lavasrc-plugin:4.7.0, sponsorblock-plugin:3.0.1, youtube-plugin:1.13.2
